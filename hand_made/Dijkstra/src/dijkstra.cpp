...
dijkstra::dijkstra()
{
    ...
    pose_sub = nh.subscribe("/slam_out_pose",10,&dijkstra::posecallback,this);
    //publish
...
void dijkstra::posecallback(const geometry_msgs::PoseStamped& msg)
{
    tt = msg.pose;
    pose_point = cv::Point2d(msg.pose.position.x, msg.pose.position.y);
}
...
int main(int argc, char * argv[])
{
    ...
    ifstream file_edge("/home/wecar/catkin_ws/src/hand_made/Dijkstra/path/edge.csv");
